...
# 클래스의 연산 -> +, -, *, /, //, % -> method 함수. 이들을 special method라고 부른다.빌트인클래스는 이미 이러한 special method가 정의되어 있다. 
# 예를 들어 int 클래스에는 __add__, __sub__, __mul__, __truediv__, __floordiv__, __mod__ 등이 정의되어 있다.
